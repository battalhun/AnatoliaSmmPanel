...
<li>
    <a class="dropdown-item text-danger" href="javascript:void(0)" onclick="deleteService(${p.data.id})">
...
async function enableService(id) {
    ...
    try {
        ...
        const res = await fetch(`/admin/services/GetEnableServices/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': token
...
async function deleteService(id) {
    ...
    try {
        ...
        const res = await fetch(`/admin/services/GetDeletedService/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': token
