...
public class Menu
{
    ...
    public ICollection<MenuPermission> MenuPermissions { get; set; } = new List<MenuPermission>(); // Menu'nün hangi izinlere sahip olduğunu belirtir, bu koleksiyon birden fazla izin içerebilir
}