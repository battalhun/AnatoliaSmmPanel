...
public class AuthMenu
{
    ...
    public ICollection<AuthMenuPermission> authMenuPermissions { get; set; } = new List<AuthMenuPermission>(); 
    // Menu'nün hangi izinlere sahip olduğunu belirtir, bu koleksiyon birden fazla izin içerebilir
}
