...
public class AdminMenuViewModel
{
    ...
    public List<AdminMenuPermissionViewModel> AdminMenuPermissions { get; set; } = null!; // AdminMenuPermissions, menünün hangi roller tarafından görüntülenebileceğini belirtir
}
