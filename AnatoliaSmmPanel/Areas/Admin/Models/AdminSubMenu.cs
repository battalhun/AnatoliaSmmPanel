...
public class AdminSubMenu
{
    ...
    // AdminMenu ile ilişki
    public AdminMenu AdminMenu { get; set; } = null!; // İlişkili olduğu ana menü
    public int AdminMenuId { get; set; } // İlişkili olduğu ana menünün ID'si
    public ICollection<AdminSubMenuPermission> AdminSubMenuPermissions { get; set; } = new List<AdminSubMenuPermission>(); 
    // AdminSubMenuPermissions, Menu'nün hangi izinlere sahip olduğunu belirtir, bu koleksiyon birden fazla izin içerebilir
