...
namespace AnatoliaSmmPanel.Areas.Admin.Controllers
{
    ...
    public class AppearanceController : Controller
    {
        ...
        public AppearanceController(ILogger<AppearanceController> logger, ApplicationDbContext context, ISmmApiService smmApiService, UserManager<ApplicationUser> userManager)
        {
            _logger = logger;
            _context = context;
